...
export const BlockRenderer = ({blocks}) => {
          return blocks.map(block => {
                    switch (block.name) {
                              ...
                              case"core/gallery":{
                                        return <Gallery key={block.id} columns={block.attributes.columns || 3} cropImages={block.attributes.imageCrop} items={block.innerBlocks}/>;
                              }
                              ...
                              case 'core/heading': {
                                        return (
                                                  <Heading key={block.id} textAlign={block.attributes.textAlign} level={block.attributes.level} content={block.attributes.content}/>
                                        )
                              }
                              case 'acf/ctabutton' : {
                                        return (
                                                  <CallToActionButton 
                                                  key={block.id} 
                                                  buttonLable={block.attributes.data.lable} 
